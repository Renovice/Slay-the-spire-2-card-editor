...
internal static class CardEditorCardTypeCostAuras
{
	...
	{
		return GetCostDelta(combatState, card, CardExtraEffectKind.CardTypeCostsLess);
	}

	public static int GetStarCostDelta(CombatState combatState, CardModel card)
	{
		return GetCostDelta(combatState, card, CardExtraEffectKind.CardTypeStarCostsLess);
	}

	private static int GetCostDelta(CombatState combatState, CardModel card, CardExtraEffectKind kind)
	{
